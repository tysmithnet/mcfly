    ...
    internal static class DomainEntityConversion
    {
        ...
        public static FrameEntity ToFrameEntity(this Frame frame)
        {
            return new FrameEntity
            {
                ...
                St0 = frame.RegisterSet.St0?.ToHexString(),
                St1 = frame.RegisterSet.St1?.ToHexString(),
                St2 = frame.RegisterSet.St2?.ToHexString(),
                St3 = frame.RegisterSet.St3?.ToHexString(),
                St4 = frame.RegisterSet.St4?.ToHexString(),
                St5 = frame.RegisterSet.St5?.ToHexString(),
                St6 = frame.RegisterSet.St6?.ToHexString(),
                St7 = frame.RegisterSet.St7?.ToHexString(),
                ...
                Ymm0 = frame.RegisterSet.Ymm0?.ToHexString(),
                Ymm1 = frame.RegisterSet.Ymm1?.ToHexString(),
                Ymm2 = frame.RegisterSet.Ymm2?.ToHexString(),
                Ymm3 = frame.RegisterSet.Ymm3?.ToHexString(),
                Ymm4 = frame.RegisterSet.Ymm4?.ToHexString(),
                Ymm5 = frame.RegisterSet.Ymm5?.ToHexString(),
                Ymm6 = frame.RegisterSet.Ymm6?.ToHexString(),
                Ymm7 = frame.RegisterSet.Ymm7?.ToHexString(),
                Ymm8 = frame.RegisterSet.Ymm8?.ToHexString(),
                Ymm9 = frame.RegisterSet.Ymm9?.ToHexString(),
                Ymm10 = frame.RegisterSet.Ymm10?.ToHexString(),
                Ymm11 = frame.RegisterSet.Ymm11?.ToHexString(),
                Ymm12 = frame.RegisterSet.Ymm12?.ToHexString(),
                Ymm13 = frame.RegisterSet.Ymm13?.ToHexString(),
                Ymm14 = frame.RegisterSet.Ymm14?.ToHexString(),
                Ymm15 = frame.RegisterSet.Ymm15?.ToHexString(),
