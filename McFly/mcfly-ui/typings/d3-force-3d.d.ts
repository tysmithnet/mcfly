...
export interface ForceZ<NodeDatum extends SimulationNodeDatum> extends Force<NodeDatum, any> {
    strength(): (d: NodeDatum, i: number, data: Array<NodeDatum>) => number;
    strength(strength: number): ForceZ<NodeDatum>;
    strength(strength: (d: NodeDatum, i: number, data: Array<NodeDatum>) => number): ForceZ<NodeDatum>;
    z(): (d: NodeDatum, i: number, data: Array<NodeDatum>) => number;
    z(z: number): ForceZ<NodeDatum>;
    z(z: (d: NodeDatum, i: number, data: Array<NodeDatum>) => number): ForceZ<NodeDatum>;
}

export function forceZ<NodeDatum extends SimulationNodeDatum>(): ForceZ<NodeDatum>;
export function forceZ<NodeDatum extends SimulationNodeDatum>(z: number): ForceZ<NodeDatum>;
export function forceZ<NodeDatum extends SimulationNodeDatum>(z: (d: NodeDatum, i: number, data: Array<NodeDatum>) => number): ForceZ<NodeDatum>;
}